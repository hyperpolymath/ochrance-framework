...
git clone <https://github.com/hyperpolymath/ochrance-framework.git> cd
ochrance-framework
...
toolbox create ochrance-framework-dev toolbox enter
ochrance-framework-dev \# Install dependencies manually
...
ochrance-framework/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
...
runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/ochrance-framework/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/ochrance-framework/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/ochrance-framework/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/ochrance-framework/labels/perimeter-3) — Community sandbox scope
