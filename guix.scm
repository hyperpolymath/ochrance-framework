...
;;
;; Guix package definition for ochrance-framework
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace ochrance-framework and customize inputs for your language/stack.
...
(package
  ...
  (home-page "https://github.com/hyperpolymath/ochrance-framework")
  (synopsis "ochrance-framework")
