...
// Replace ochrance-framework, Ochrance Framework — See README.adoc for details., just run, Ochrance Framework started successfully. with actuals
= ochrance-framework — Quick Start for Users
:toc:
:toclevels: 2

== What is ochrance-framework?

Ochrance Framework — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./ochrance-framework-portable
----
...
[source]
----
Ochrance Framework started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/ochrance-framework/wiki
