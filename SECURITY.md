...
============================================================================
Replace all ochrance-framework values with your information:
  Ochrance Framework     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  ochrance-framework             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/ochrance-framework/security/advisories/new)
...
- This repository (`hyperpolymath/ochrance-framework`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/ochrance-framework/security/advisories)
...
When using Ochrance Framework, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/ochrance-framework/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/ochrance-framework/security/advisories/new) or 6759885+hyperpolymath@users.noreply.github.com |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/ochrance-framework/discussions) |
...
*Thank you for helping keep Ochrance Framework and its users safe.* 🛡️
